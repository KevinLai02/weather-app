...
function Main({navigation}: {navigation: any}): JSX.Element {
  ...
  source={require('../../img/background.png')}  />*/}
      ...
      <View>
        <View
          style={tw`opacity-50 h-[200px] justify-end bg-[#fff] rounded-t-[30px]`}>
          <View style={tw`items-center mb-[50px] `}>
            <TouchableOpacity
              style={tw`rounded-[1000px] h-[40px] w-[120px] bg-[#2A52BE] justify-center`}
              onPress={() => {
                searchWeatherApi();
              }}>
              <Text style={tw`text-[#fff] text-center text-[16px]`}>
                reload
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={tw`absolute`}>
          <Text style={tw`z-10 text-[25px] text-[#fff] ml-[10px]`}>
            {weather}
          </Text>
          <Text style={tw`z-10 text-[18px] text-[#fff] ml-[10px]`}>
