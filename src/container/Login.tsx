...
function Login({navigation}: {navigation:any}): JSX.Element {
  ...
  source={require('../../public/images/background.png')}  />*/}
        ...
        <View style={tw`h-[700px] bg-[#fff] rounded-t-[30px]`}>
            ...
            <TouchableOpacity style={tw`bg-[#2A52BE] w-[85%] h-[50px] rounded-[10px] ml-[30px] mt-[100px] justify-center`}>
                <Text style={tw`text-[#fff] text-[20px] font-bold text-center`}> Login</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={tw`bg-[#fff] w-[85%] h-[50px] rounded-[10px] ml-[30px] mt-[25px] justify-center border-[2px] border-[#2A52BE]`}>
                <Text style={tw`text-[#2A52BE] text-[20px] font-bold text-center`}> Login With Google</Text>
            </TouchableOpacity>
            <View style={tw`flex-row items-center justify-center h-[60px]`}>
                <Text style={tw`font-medium`}>Didn't have account?</Text>
                <TouchableOpacity onPress={()=> navigation.navigate('SignUp')}>
                    <Text style={tw`text-[#2A52BE] font-medium `} >Sign up</Text>
                </TouchableOpacity>
            </View>
      </View>
    </SafeAreaView>
